...
// Mark all as read  — NOTE: must be before /:notificationId routes
...
// Clear all reviewed (accepted/rejected) notifications
router.delete('/clear-reviewed', authMiddleware, async (req, res) => {
  try {
...
// Clear old notifications without applicationId
